...
$(document).ready(function(){
    ...
    if (roomid > 0) {
        ...
        chat.user.gravatar = ce.getGravatarUrl(chat.user.email,80,false);
...
chat.add_user_banner_information = function(data)
{
    ...
    if ( (typeof(data.session.location) != "undefined") && (typeof(data.session.location.address) != "undefined") ) {
        ...
        $('.chat-request-info-map .operating-system img').attr('title',data.session.os).attr('src','../templates/common/img/'+data.os.toLowerCase()+'.png');
