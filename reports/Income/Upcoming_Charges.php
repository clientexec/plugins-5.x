...
//CE_Lib::redirectPage($_SERVER['PHP_SELF'].'?fuse=reports&amp;report=Upcoming+Charges&amp;controller=index&amp;type=Income&amp;view=viewreport&sortbydate='.(($sortbydate)? 1 : 0));
        ...
        echo '<div style="margin-left:20px;position:relative;top:25px;"><form name="chargesForm" method="post" action="'.$_SERVER['PHP_SELF'].'?fuse=reports&amp;report=Upcoming+Charges&amp;controller=index&amp;type=Income&amp;view=viewreport&Transactions'.(($sortbydate)? 1 : 0).'" />'
                .$scriptCode
                .$TriggerServerPluginField
                .$actionsDescription
                .'<table>'
                .'    <tr>'
                .'        <td>'
                .'            <a href="'.$_SERVER['PHP_SELF'].'?fuse=reports&amp;report=Upcoming+Charges&amp;controller=index&amp;type=Income&amp;view=viewreport&sortbydate='.(($sortbydate)? '0">'.$this->user->lang('Sort By Payment Type') : '1">'.$this->user->lang('Sort By Date')).'</a>'
                .'        </td>'
                .$FormButtons
                .'    </tr>'
                .'</table>'
